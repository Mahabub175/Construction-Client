...
import NewsletterCreate from "@/components/Dashboard/Admin/Newsletter/NewsletterCreate";
import NewsletterEdit from "@/components/Dashboard/Admin/Newsletter/NewsletterEdit";
...
const Newsletter = () => {
  ...
  const { data: newsletters, isFetching } = useGetNewslettersQuery({
    page: currentPage,
    limit: pageSize,
    search,
  });

  const { data: newsletterData } = useGetSingleNewsletterQuery(itemId, {
    skip: !itemId,
  });
  ...
  const [deleteBulkNewsletter] = useDeleteBulkNewsletterMutation();
  ...
  const tableData = newsletters?.results?.map((item) => ({
    key: item?._id,
  ...
  return (
    <>
      <TableHeader
        ...
        deleteBulk={deleteBulkNewsletter}
      ...
      <Pagination
        ...
        total={newsletters?.meta?.totalCount}
        current={currentPage}
      ...
      <NewsletterCreate open={open} setOpen={setOpen} />
      <NewsletterEdit itemId={itemId} open={openEdit} setOpen={setOpenEdit} />
      <DetailsModal
        itemId={itemId}
