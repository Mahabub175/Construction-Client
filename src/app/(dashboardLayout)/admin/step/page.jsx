...
import StepCreate from "@/components/Dashboard/Admin/Step/StepCreate";
import StepEdit from "@/components/Dashboard/Admin/Step/StepEdit";
...
const Step = () => {
  ...
  const { data: stepData } = useGetSingleStepQuery(itemId, {
    skip: !itemId,
  });
  ...
  const [deleteBulkStep] = useDeleteBulkStepMutation();
  ...
  const tableData = steps?.results?.map((item) => ({
    key: item._id,
  ...
  return (
    <>
      ...
      <StepCreate open={open} setOpen={setOpen} />
      <StepEdit itemId={itemId} open={openEdit} setOpen={setOpenEdit} />
      <DetailsModal
        itemId={itemId}
